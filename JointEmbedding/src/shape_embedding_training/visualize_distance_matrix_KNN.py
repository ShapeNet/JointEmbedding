...
shape_distance_matrix = [[float(value) for value in line.strip().split(' ')] for line in open(g_shape_embedding_space_file_txt, 'r')]
...
visualization_filename = os.path.join(BASE_DIR, 'visualize_distance_matrix_KNN_%s.html'%(args.query_idx))
