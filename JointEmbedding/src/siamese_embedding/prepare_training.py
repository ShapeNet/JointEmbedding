...
for line in fileinput.input(g_siamese_embedding_train_val_prototxt, inplace=True):
    line = line.replace('/path/to/syn_images_pairs_pool5_lmdb_train', g_pool5_lmdb_train)
    line = line.replace('/path/to/syn_images_pairs_pool5_lmdb_val', g_pool5_lmdb_val)
