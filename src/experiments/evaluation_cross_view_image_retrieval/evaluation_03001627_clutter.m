...
embedding = importdata(fullfile(evaluation_folder, 'image_embeddings_03001627_clutter.txt'));
...
%%
load(fullfile(evaluation_folder, 'ground_truth_03001627_clutter.mat'));
image_list = find(ground_truth(14, :) == 0);
